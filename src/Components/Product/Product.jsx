        ...
        {Dataset[selectedCategory]?.map((product, index) => (
          ...
          >
            ...
            <div className="p-4 lg:w-ful flex flex-col justify-between pt-12 ">
              ...
              <div className="flex justify-between">
                <button className="relative flex h-10 w-36 items-center justify-center overflow-hidden rounded-lg bg-yellow-500 shadow-md transition-transform duration-500 hover:scale-105 active:scale-95">
                  <span className="relative flex items-center justify-center transition-transform duration-500 group-hover:left-[-30px]">
                    <FaOpencart className="translate-x-[-10px] transition-transform duration-500 group-hover:translate-x-[10px]" />
                  </span>
                  <p className="relative z-20 text-sm font-semibold text-black transition-transform duration-500 group-hover:translate-x-2">
                    Add to Cart
                  </p>
                </button>
                <button className="">
